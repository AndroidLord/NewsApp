...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        homeRecyclerView.setAdapter(newsRecyclerAdaptor);
    ...
    private void findNews() {
         ...
         Call<NewsApiClient> newsModelCall = Service.getNewsAPI().getHeadlineNews(
         ...
         newsModelCall.enqueue(new Callback<NewsApiClient>() {
             ...
             public void onResponse(Call<NewsApiClient> call, Response<NewsApiClient> response) {
                 if(response.isSuccessful()){
                     newsModelList.addAll(response.body().getArticles());
